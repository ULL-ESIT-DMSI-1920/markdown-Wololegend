...
Digamos que queremos escribir algo con un formato de párrafo muy concreto. Puede ser poesía, por ejemplo.

Si simplemente escribimos el poema con los saltos de línea donde van nos queda todo en un solo párrafo:

_Con diez cañones por banda,
viento en popa a toda vela,
no corta el mar, sino vuela
un velero bergantín_

Pero si añadimos dos espacios al final de cada línea de la siguiente forma se formatea de forma adecuada (los espacios están indicados con ";").

```
_Con diez cañones por banda,;;
viento en popa a toda vela,;;
no corta el mar, sino vuela;;
un velero bergantín;;_
```
